...
function test_knapsack_exact(f::Function)
	@testset "Simple Knapsack instances with integer values" begin
		...
		@test issetequal(f(weights, values, maxWeight), optimal)
...
test_knapsack_exact(knapsack_dp)
test_knapsack_exact(knapsack_ip)
